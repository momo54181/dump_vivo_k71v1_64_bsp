...
rm /data/system/slaConfig.xml #sla

rm /data/system/dualwifiConfig.xml #dualwifi
...
rm -r /data/data/com.vivo.weather.provider/shared_prefs/weather_provider_restore.xml
...
rm -rf  /data/data/com.vivo.smartunlock/shared_prefs
...
rm -rf /data/data/com.volte.config/shared_prefs/
rm -rf /data/data/com.volte.config/databases/

#add by CaoYuan for FloatingCamera
rm -rf /data/data/com.vivo.video.floating/shared_prefs/

#add by lifei for SmartRing
rm -rf /data/data/com.vivo.smartring/shared_prefs/

#add by yantiefang for Cmcc Rcs
rm -rf /data/data/com.suntek.mway.rcs.app.service/shared_prefs/

#add by zhaweidong for notification classify
rm -r /data/bbkcore/notification_classify_config.xml
